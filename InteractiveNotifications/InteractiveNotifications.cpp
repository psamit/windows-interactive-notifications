...
#define __CSID "ab72572a-8bd6-40fc-bd84-1861b70f8d38"
...
public:
		...
		ULONG dataCount) override
	{
		...
		// std::string systemCmd = "tenfold://" + escapedToastArgs + "^&userData=[{" + escapedArgs + "}]";
		...
		std::string cmd = "tenfold://" + escapedToastArgs + "&userData=[{" + escapedArgs + "}]";
...
namespace InteractiveNotifications
{
	...
	INTERACTIVENOTIFICATIONS_API HRESULT RegisterComServer(PCWSTR exePath)
	{
		...
		auto key = LR"(SOFTWARE\Classes\CLSID\{ab72572a-8bd6-40fc-bd84-1861b70f8d38}\LocalServer32)";
